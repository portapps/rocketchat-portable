...
func rocketChatLnk() (*asset, error) {
	...
	info := bindataFileInfo{name: "Rocket.Chat.lnk", size: 1776, mode: os.FileMode(438), modTime: time.Unix(1538528985, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"Rocket.Chat.lnk": &bintree{rocketChatLnk, map[string]*bintree{}},
}}
